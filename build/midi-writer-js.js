(function () {
    ...
    MidiWriter.NoteOnEvent = function (fields) { this.data = fields.data; };
    MidiWriter.NoteOffEvent = function (fields) { this.data = fields.data; };
    ...
    MidiWriter.Writer.prototype.dataUri = function () { return 'data:audio/midi;base64,' + this.base64(); };
    ...
    MidiWriter.stringByteCount = function (s) { return encodeURI(s).split(/%..|./).length - 1; };
    ...
    MidiWriter.stringToBytes = function (string) { return string.split('').map(function (char) { return char.charCodeAt(); }); };
    MidiWriter.isNumeric = function (n) { return !isNaN(parseFloat(n)) && isFinite(n); };
    MidiWriter.VexFlow = {};
    ...
    MidiWriter.VexFlow.convertPitch = function (pitch) { return pitch.replace('/', ''); };
